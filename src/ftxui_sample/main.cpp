...
// configuration step. It creates a namespace called `GlueCppLinter`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", GlueCppLinter::cmake::project_name, GlueCppLinter::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", GlueCppLinter::cmake::project_version);
      return EXIT_SUCCESS;
    }
